...
- (void)testGetDatabaseHelper {
    ...
    XCTAssertTrue([a.databasePath rangeOfString:@"io.rakam.database_a"].location != NSNotFound);
    XCTAssertTrue([b.databasePath rangeOfString:@"io.rakam.database_b"].location != NSNotFound);
    XCTAssertTrue([dbHelper.databasePath rangeOfString:@"io.rakam.database"].location != NSNotFound);
    XCTAssertTrue([dbHelper.databasePath rangeOfString:@"io.rakam.database_"].location == NSNotFound);
